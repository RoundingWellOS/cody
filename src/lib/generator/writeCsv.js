...
function writeCsvLibrary() {
    ...
    const jsonLibrary =  JSON.parse(fs.readFileSync(join(__dirname, 'src/library/icd_codes.json'), 'utf8'));
    ...
    fs.writeFileSync(join(__dirname, `src/library/icd_codes.csv`), rows.join('\n'));
}
